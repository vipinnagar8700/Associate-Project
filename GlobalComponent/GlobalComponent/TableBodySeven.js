...
const TableBodySeven = ({ name1, name2, name3, name4, name5, name6,fontsize ,name7}) => {
  return (
    <Grid container>
      <Cusstyle/>
      <Grid item xs={12}>
        <Table style={{margin:0,border:"none"}}>
          <tbody>
            <tr style={{borderTop:"none"}}>
              <td className="width_50" style={{textAlign:"center",fontSize: `${fontsize}`,verticalAlign:"middle"}}>{name7}</td>
